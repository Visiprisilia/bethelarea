                                    ...
                                    <div class="sbp-preview-content">
                                        ...
                                        <form action="/updateevaluasi/{{$item->kode_proker}}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="kode_proker" name="kode_proker" disabled value="{{$item->kode_proker}}"/>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="nama_proker" name="nama_proker" value="{{$item->nama_proker}}"/>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="akun_beban" name="akun_beban" value="{{$item->akun_beban}}"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Rencana Anggaran</label>
                                                <input class="form-control" id="rencana_anggaran" name="rencana_anggaran" value="{{$item->rencana_anggaran}}"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Realisasi Anggaran</label>
                                                <input class="form-control" id="realisasi_anggaran" name="realisasi_anggaran" value="{{$item->realisasi_anggaran}}"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Rencana Waktu</label>
                                                <input class="form-control" id="rencana_waktu" name="rencana_waktu" value="{{$item->rencana_waktu}}"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Realisasi Waktu</label>
                                                <input class="form-control" id="realisasi_waktu" name="realisasi_waktu" value="{{$item->realisasi_waktu}}" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Indikator Pencapaian</label>
                                                <input class="form-control" id="indikator_pencapaian" name="indikator_pencapaian" value="{{$item->indikator_pencapaian}}" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Kinerja Pencapaian</label>
                                                <input class="form-control" id="kinerja_pencapaian" name="kinerja_pencapaian" value="{{$item->kinerja_pencapaian}}" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Faktor Pendorong</label>
                                                <input class="form-control" id="faktor_pendorong" name="faktor_pendorong" value="{{$item->faktor_pendorong}}" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Faktor Penghambat</label>
                                                <input class="form-control" id="faktor_penghambat" name="faktor_penghambat" value="{{$item->faktor_penghambat}}" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Tindak Lanjut</label>
                                                <input class="form-control" id="tindaklanjut" name="tindaklanjut" value="{{$item->tindaklanjut}}"/>
                                            </div>

                                        ...
                                        <form action="/konfirmasi/{{$items->kode_proker}}" method="post">
                                            ...
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" readonly id="anggaran" name="anggaran" readonly value="{{ $items->anggaran}}" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="exampleFormControlInput1">Keterangan</label>
                                                    <input class="form-control" id="keterangan_proker" name="keterangan_proker" readonly value="{{ $items->keterangan_proker}}" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                            <div class="col-md-6">

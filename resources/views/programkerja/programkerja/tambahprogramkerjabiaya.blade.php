        ...
        <div class="container-xl px-4 mt-n10">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div id="default">
                        <div class="card mb-4">
                            <div class="card-header">Program Kerja Anggaran Biaya</div>
                            <div class="card-body">
                                <!-- Component Preview-->
                                <div class="sbp-preview">
                                    <div class="sbp-preview-content">
                                        <form action="/simpanprogramkerjabiaya" method="post">
                                            @csrf
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" readonly id="anggaran" name="anggaran" value="0" />
                                                </div>
                                            </div>

                                ...
                                <div class="sbp-preview">
                                    ...
                                    <form action="/updatemurid/{{$itemz->nomor_induk}}" method="post"  enctype="multipart/form-data">
                                            ...
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                                <label class="mb-1" for="inputFirstName">Kelas</label>
                                                    <input class="form-control" id="kelas" name="kelas" readonly value="{{$itemz->kelas}}" placeholder="Masukkan NISN" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" type="file" id="foto_murid" name="foto_murid" readonly value="{{$itemz->foto_murid}}"  />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" type="file" id="ktp_ayah" name="ktp_ayah"  readonly value="{{$itemz->ktp_ayah}}" placeholder="Masukkan Pendidikan Terakhir Ayah" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" type="file" id="ktp_ibu" name="ktp_ibu"  readonly value="{{$itemz->ktp_ibu}}" placeholder="Masukkan Pendidikan Terakhir Ayah" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" type="file" id="file_akte" name="file_akte"  readonly value="{{$itemz->file_akte}}" placeholder="Masukkan Nomor Akte Lahir" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Nomor Kontak</label>
                                                    <input class="form-control" id="kontak" name="kontak"  readonly value="{{$itemz->kontak}}" placeholder="Masukkan Nomor Kontak" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Kartu Keluarga</label>
                                                    <input class="form-control" type="file" id="file_kk" name="file_kk"  readonly value="{{$itemz->file_kk}}" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Tanggal Siswa Diterima</label>
                                                    <input class="form-control" type="date" id="tanggal_penerimaan" name="tanggal_penerimaan"  readonly value="{{$itemz->tanggal_penerimaan}}" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Bukti Diterima</label>
                                                    <input class="form-control" type="file" id="file_suratpenerimaan" name="file_suratpenerimaan"  readonly value="{{$itemz->file_suratpenerimaan}}" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Tanggal Kenaikan Kelas</label>
                                                    <input class="form-control" type="date" id="tanggal_kenaikankelas" name="tanggal_kenaikankelas" readonly value="{{$itemz->tanggal_kenaikankelas}}"/>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Bukti Kenaikan Kelas</label>
                                                    <input class="form-control" type="file" id="file_suratkenaikankelas" name="file_suratkenaikankelas"  readonly value="{{$itemz->file_suratkenaikankelas}}" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Tanggal Penerimaan Raport</label>
                                                    <input class="form-control" type="date" id="tanggal_raport" name="tanggal_raport"  readonly value="{{$itemz->tanggal_raport}}" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="mb-1" for="inputFirstName">Bukti Penerimaan Raport</label>
                                                    <input class="form-control" type="file" id="file_raport" name="file_raport"  readonly value="{{$itemz->file_raport}}" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-4">

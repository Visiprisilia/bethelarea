...
class DaftarTagihan extends Model
{
    ...
    protected $fillable = ['daftar_nis_tagihan','daftar_periode_tagihan','daftar_nominal_tagihan','daftar_namakategori_tagihan'];
...
//new daftar tagihan
// CREATE or REPLACE VIEW daftartagihan as 
// SELECT rincian_nis_tagihan daftar_nis_tagihan , rincian_periode_tagihan daftar_periode_tagihan, SUM(rincian_nominal_tagihan)daftar_nominal_tagihan, rincian_namakategori_tagihan daftar_namakategori_tagihan
// from daftarrinciantagihan
// GROUP BY daftar_nis_tagihan